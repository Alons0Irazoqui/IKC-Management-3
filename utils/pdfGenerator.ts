...
export const generateReceipt = (
    ...
    // Colores
    const colorRedIKC: [number, number, number] = [220, 38, 38];
    const colorTextMain: [number, number, number] = [17, 24, 39];
    const colorTextMuted: [number, number, number] = [107, 114, 128];
    const colorSuccessText: [number, number, number] = [21, 128, 61];
    const colorSuccessBG: [number, number, number] = [220, 252, 231];
    const colorPendingText: [number, number, number] = [75, 85, 99];
    const colorPendingBG: [number, number, number] = [243, 244, 246];
