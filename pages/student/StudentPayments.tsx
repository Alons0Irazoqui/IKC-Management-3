                                ...
                                {selectedDebts.map(debt => (
                                    ...
                                    >
                                        ...
                                        <div className="flex items-center gap-3">
                                            <span className="font-bold text-sm text-gray-900">${((debt.amount || 0) + (debt.penaltyAmount || 0)).toFixed(2)}</span>
                                            {!isSinglePaymentMode && (
                                                <button
                    ...
                    <div className="space-y-4 pt-4 border-t border-gray-100">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className={`w-full rounded-2xl border-transparent py-4 pl-8 pr-4 text-2xl font-black transition-all outline-none ${!isPartialEnabled
                                ...
                                {inReviewRecords.map((record) => (
                                    ...
                                    >
                                        ...
                                        <div className="text-right w-full sm:w-auto flex justify-between sm:block items-center">
                                            <span className="text-lg font-bold text-gray-600 block">${((record.amount || 0) + (record.penaltyAmount || 0)).toFixed(2)}</span>
